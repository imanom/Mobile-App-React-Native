...
export class POUsageHistory extends Component {
 ...
 <View style={styles.container}>
    ...
    //  style={{  }}
     ...
     //initialPage={this.props.nav.getParam('itemId', 0)}
     initialPage={0}
   ...
   >
     ...
     <UsageHistData nav={this.props.navigation}/>
     </View>
     <View tabLabel='   Voice   ' style={{flex:1}}> 
      <UsageHistVoice nav={this.props.navigation}/>
     </View>
     <View tabLabel='   SMS   ' style={{flex:1}}> 
      <UsageHistSMS nav={this.props.navigation}/>
     </View>
