...
import {
  FlatList, StyleSheet, Text, TextInput, View, StatusBar, ScrollView, Dimensions,
  ActivityIndicator, TouchableHighlight, TouchableOpacity
} from 'react-native';
...
import EmailPopComp from './popups/emailPop';
import HeaderComponent from './../../navigators/headerCode';

export class PORecharge extends Component {
