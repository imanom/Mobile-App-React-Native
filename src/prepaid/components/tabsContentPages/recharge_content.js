      ...
      render() {
        ...
        const data   = [ {label:"Special Recharge", text:"75 free outgoing minutes in nation roaming; incoming calls free; outgoing local SMS @25c/SMS; outgoing STD SMS @38c/SMS", amt:"$ 250", time:"Validity: 365 Days"},
          ...
          <View style={{width:200}}>
              <Text>
                <Text style={{fontWeight: 'bold',fontSize: 14, color: '#000',textAlign: 'left', }}>{this.props.data[i].label} </Text>
                <Text style={{fontSize: 12, color: '#696969',textAlign: 'left', }}>{this.props.data[i].text} </Text>
          ...
          <View style={styles.rupeebox}>
                ...
                <Text style={{fontSize: 18, color: '#696969',textAlign: 'left', }}>{this.props.data[i].amt}</Text>
                </Text>
                </View>
                <Text style={{fontSize: 12, color: '#C0C0C0',textAlign: 'left', }}>{this.props.data[i].time}</Text>
            </View>
